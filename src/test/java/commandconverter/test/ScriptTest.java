...
public class ScriptTest extends TestCase {
  ...
  public void test() {
    try {
      ...
      String newCommand = manager.convertCommand(
          "summon FireworksRocketEntity -246 116 679 {FireworksItem:{id:fireworks,Count:1,tag:{Fireworks:{Explosions:[{Type:1,Colors:[16711680],FadeColors:[16734502]},{Type:1,Trail:1,Colors:[16775881],FadeColors:[16775142]},{Type:1,Colors:[16711680],FadeColors:[16711680]}]}}}}"
          );
